...
export default function RequestsSent() {
    ...
    const myRequests = allRequests.filter(single => single.requestFromAddress === userWalletAddress)
  ...
  return (
    <>
      <div className="min-h-full">
        <div className="bg-teal-400 pb-32">
          ...
          <header className="py-4">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
              <h1 className="text-4xl font-bold text-white">Requests From Me</h1>
            </div>
          </header>
        </div>
        ...
        <main className="-mt-32">
          <div className="max-w-7xl mx-auto pb-12 px-4 sm:px-6 lg:px-8">
            ...
            <RequestsFromMeTable myRequestsSorted={myRequestsSorted}/>
            {/* /End replace */}
          </div>
        </main>
      </div>
