                        ...
                        <Menu as="div" className="ml-3 relative">
                          <div>
                            <Menu.Button className="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                              ...
                              <img className="h-8 w-8 rounded-full" src={userProfile ? userProfile.profilePic : 'https://thumbs.dreamstime.com/b/default-avatar-photo-placeholder-profile-picture-default-avatar-photo-placeholder-profile-picture-eps-file-easy-to-edit-125707135.jpg'} alt=""  />
                            </Menu.Button>
                          </div>
                          <Transition
                            as={Fragment}
              ...
              <Disclosure.Panel className="border-b border-gray-700 md:hidden">
                ...
                <div className="pt-4 pb-3 border-t border-gray-700">
                  <div className="flex items-center px-5">
                    <div className="flex-shrink-0">
                      <img className="h-10 w-10 rounded-full" src={userProfile ? userProfile.profilePic : 'https://thumbs.dreamstime.com/b/default-avatar-photo-placeholder-profile-picture-default-avatar-photo-placeholder-profile-picture-eps-file-easy-to-edit-125707135.jpg'} alt="" />
                    </div>
                    <div className="ml-3">
                      <div className="text-base font-medium leading-none text-white">{userProfile?.name}</div>
                      <div className="text-sm mt-2 font-medium leading-none text-gray-400"><a href={`https://etherscan.io/address/${userProfile?.walletAddress}`}>{userProfile?.walletAddress}</a></div>
                    </div>
                    <button
                      type="button"
